---
name: 23blocks-university-companies-api
description: Manage 23blocks university companies (tenants) via REST API. Use for creating companies, managing API keys for external integrations, or configuring RabbitMQ exchange settings.
